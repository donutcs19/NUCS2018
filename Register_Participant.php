        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>ลงทะเบียน(ผู้เข้าร่วมงาน)</h2>
                           
                        </div>
                        <div class="body">
                          <form action="controller/registerKdb.php" method="post" name="formregis" 
                          id="formregis" enctype="multipart/form-data" >
                           ...
                           name="payment" type="file" required accept="image/jpeg, image/png">
                            <font color="red">**(.jpg หรือ .png ขนาดไฟล์ไม่เกิน 500K เท่านั้น)</font></div><br><br>
                                    
                           
                               
                            <input type="hidden" name="type_register" value="เข้าร่วม">  
