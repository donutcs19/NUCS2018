...
<body class="theme-red" style="font-family: 'Pridi', serif;">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                รายชื่อผู้เข้าร่วมทั้งหมด (สามารถค้นหาได้จากช่อง Search)<br><br>
                                <h5><font color="green">
    ...
    $strSQL = "SELECT * FROM register_present WHERE type_register = 'เข้าร่วม' ";
    ...
    ?>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="150">มหาลัย/สถาบัน</th>
                                            <th width="100">สถานะการจ่ายเงิน</th>
                                            <th width="150">เข้าร่วมฟังบรรยายพิเศษ</th>
              ...
              <a href="upload/payment/<?php echo "".$row['payment'].""; ?>" target="_blank">
                <img src="img/pass.png" style="width:20%"></a>
                <?php }else if($row['university'] == 'มหาวิทยาลัยแม่โจ้'){ ?> <img src="img/mju.gif" style="width:20%"> 
                <?php }else if($row['university'] == 'มหาวิทยาลัยราชภัฏเชียงใหม่'){ ?> <img src="img/crmu.png" style="width:30%">
                <?php }else if($row['university'] == 'มหาวิทยาลัยเชียงใหม่'){ ?> <img src="img/cmu.png" style="width:20%">
                <?php }else{ ?><font color="red">ไม่จ่ายเงิน </font>  <?php }?></td>
