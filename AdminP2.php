...
<?php
    ...
    ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                แก้ไขข้อมูลผู้ที่ลงทะเบียน (ไม่สามารถเซฟเป็น PDF ได้)
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                        <tr>
                                            <td width="500">ชื่อ-สกุล</td>
                                            <td width="5">สถานะ</td>
                                            <td width="200">มหาลัย/สถาบัน</td>
                                            <td width="200">การเข้าร่วม</td>
                                            <td width="200">บทความ</td>
                                            <td width="1">Word บทคัดย่อ</td>
                                            <td width="1">PDF บทคัดย่อ</td>
                                            <td width="1">Word บทความฉบับเต็ม</td>
                                            <td width="1">PDF บทความฉบับเต็ม</td>
                                            <td width="1">ผลรีวิว</td>
                                            <td width="1">รีวิว</td>
            ...
            <td align="center"><?php if($row['file_word'] !== '' && $row['file_word'] !== null){ ?>
               <a href="upload/file_word_บทคัดย่อ/<?php echo "".$row['file_word'].""; ?>" target="_blank">
                <font color="green">ส่ง </font></a> <?php 
                }else{ ?><font color="red">ไม่ส่ง </font>  <?php }?></td>
            
            <td align="center"><?php if($row['file_pdf'] !== '' && $row['file_pdf'] !== null){ ?> 
                <a href="upload/file_pdf_บทคัดย่อ/<?php echo "".$row['file_pdf'].""; ?>" target="_blank">
                <font color="green">ส่ง </font></a><?php }
                else{ ?><font color="red">ไม่ส่ง </font><?php }?></td>

            <td align="center"><?php if($row['file_word2'] !== '' && $row['file_word2'] !== null){ ?>
               <a href="upload/file_word_บทความฉบับเต็ม/<?php echo "".$row['file_word2'].""; ?>" target="_blank">
                <font color="green">ส่ง </font></a> <?php 
                }else{ ?><font color="red">ไม่ส่ง </font><?php }?></td>
            
            <td align="center"><?php if($row['file_pdf2'] !== '' && $row['file_pdf2'] !== null){ ?> 
                <a href="upload/file_pdf_บทความฉบับเต็ม/<?php echo "".$row['file_pdf2'].""; ?>" target="_blank">
                <font color="green">ส่ง </font></a><?php }
                else{ ?><font color="red">ไม่ส่ง </font> <?php }?></td>
            
            
            <td><?php if($row['review'] == 'pass'){ ?><img src="img/pass.png" style="width:100%"><!--<font>ผ่าน</font>-->
                <?php }else if($row['review'] == 'fail'){ ?> <img src="img/fail.png" style="width:100%"><!--<font>ไม่ผ่าน</font>--> 
                <?php } else { ?><img src="img/wait.png" style="width:100%"><!--<font>รอ</font>--> <?php }?></td>
            
            <td><button type="button" onclick="return confirm('ต้องการแก้ไข <?php echo "".$row['fontname']." ".$row['name']." ".$row['sname'].""; ?> ???')" class="btn bg-amber btn-xs waves-effect"><a href="Review.php?ID=<?php echo $row["id"];?>" ><i class="material-icons">mode_edit</i></a></button></td>
